/// obj_chain_button_continue : Left Pressed Event
// Returns to the gate after resolving the flow.
if (point_in_rectangle(mouse_x, mouse_y, x, y, x + button_width, y + button_height)) {
    if (variable_global_exists("gate_room") && global.gate_room != undefined) {
        ...
        show_debug_message("Chain Reaction continue pressed; gate room not set.");
    }
}
