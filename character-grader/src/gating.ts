import { GradeInput, LessonTile, Seeder, SignalReport } from "./types.js";

const meetsPrecedence = (
  tile: LessonTile,
  unlocked: string[]
): boolean => {
...
const withinDialect = (tile: LessonTile, level: number): boolean => {
  return tile.language.dialect_level <= level;
};

export const suggestNextUnlocks = (
  input: GradeInput,
