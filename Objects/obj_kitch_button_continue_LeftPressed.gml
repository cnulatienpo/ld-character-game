/// obj_kitch_button_continue : Left Pressed Event
// Returns to the gate or logs if unavailable.
if (point_in_rectangle(mouse_x, mouse_y, x, y, x + button_width, y + button_height)) {
    if (variable_global_exists("gate_room") && global.gate_room != undefined) {
        ...
        show_debug_message("Form Kitchen continue pressed; gate room not set.");
    }
}
