...
const CONCEPTS = ["Description","Presence","Identity","Conflict","Stakes","Outcome"];
...
function readTropeEntries(datasetDir) {
...
function buildPassage(entry, concept, index) {
...
function generateQuizItems(entries, limit, fileIndex) {
  const items = [];
...
function writeQuizFile(datasetDir, filename, items) {
